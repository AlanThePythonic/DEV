...
public interface Pool<T> {
	 ...
	 * available the call returns it else the call returns <code>null</code>.
	 * 
	 * The validity of the objects are determined using the {@link Validator}
	 * interface, such that an object <code>o</code> is valid if
	 ...
	 * the <code>invalidate()</code> method of the {@link Validator} interface.
	 */
	 ...
	 *
	 * @param <T>
	 *            the type of objects to validate and cleanup.
	 */
	public static interface Validator<T> {
		 ...
		 * want to close the connections. This is done via the
